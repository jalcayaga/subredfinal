    ...
    <section>
      ...
      >
        ...
        >
          ...
          >
            <CardBody>
              <Heading size="lg" className="font-poppins py-6" fontSize="30">
                {" "}
                Seguridad Integral
              </Heading>
          ...
          >
            <CardBody>
              ...
              <Text py="6" fontSize="15">
                ...
                diseño que combina los potentes y fiables sistemas de seguridad
                del pasado con la sencillez de la mejor tecnología del futuro.
                <br />
                <br />
                AX PRO es tanto convencional como revolucionario, con una
                estabilidad inalámbrica probada, una amplia gama de productos de
                primera clase y fácil de usar tanto para los instaladores como
                para los usuarios finales. Una configuración sencilla y una
                protección potente, ya sea para la propiedad de un empresario o
                para los seres queridos de un particular, aporta tranquilidad
